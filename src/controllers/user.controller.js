...
const generateAccessAndRefreshToken = async (userId) => {
	try {
		...
		await user.save({ validateBeforeSave: false }); //only save the updated value not reassign the whole document/object
...
const updateUserCoverImage = asyncHandler(async (req, res) => {
	...
	if (!user) {
		throw new ApiError(500, "Cover image updation failed");
	}
